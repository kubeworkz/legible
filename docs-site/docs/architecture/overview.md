...
All services communicate over a Docker bridge network (`wrenai_wren`). Only selected ports are exposed to the host:

| Port | Service    | Purpose |
|------|------------|---------|
| 3000 | Legible UI | Main user interface |
