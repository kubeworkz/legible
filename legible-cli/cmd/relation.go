...
Use 'legible model list' to find model IDs and 'legible model fields <id>'
to find column/field IDs.

Examples:
  legible relation create --from-model 3 --from-column 12 --to-model 1 --to-column 1 --type ONE_TO_MANY`,
...
Examples:
  legible relation update 5 --type MANY_TO_ONE`,
...
var relationDeleteCmd = &cobra.Command{
	...
	Long: `Delete a relationship by ID. Use 'legible relation list' to find IDs.

Examples:
  legible relation delete 5`,
	Args: cobra.ExactArgs(1),
