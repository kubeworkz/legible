...
Examples:
  legible calc-field create --model 1 --name "total_orders" --expression COUNT --lineage 5
  legible calc-field create --model 1 --name "avg_price" --expression AVG --lineage 12,15`,
...
Examples:
  legible calc-field validate --model 1 --name "total_orders"`,
