...
var sqlCmd = &cobra.Command{
	...
	Long: `Convert a natural language question into SQL using the Legible AI pipeline.
Returns only the generated SQL without executing it.

This may take up to 3 minutes depending on query complexity.

Examples:
  legible sql "What are the top 10 customers by revenue?"
  legible sql "How many orders per month?" --dialect
  legible sql "Revenue by region" --json`,
