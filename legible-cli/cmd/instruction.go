...
Examples:
  legible instruction create --global --text "Always use fiscal year calendar"
  legible instruction create --text "Revenue means net revenue" --question "What is revenue?" --question "Show revenue"`,
...
Examples:
  legible instruction update 1 --text "Use calendar year instead"
  legible instruction update 2 --question "New question" --question "Another"
  legible instruction update 3 --global`,
...
func runInstructionList(cmd *cobra.Command, args []string) error {
	...
	if cfg.ProjectID == "" {
		return fmt.Errorf("no project selected — run: legible project use <id>")
	}
